    ...
    <div class="card">
      ...
      <div class="card-body ">
        <div class="container mt-3">
          <table id="tabla-estudiantes" class="table table-striped text-center">
            <colgroup>
              <col width="5%">
              <col width="15%">
              <col width="15%">
      ...
      <div class="card-footer text-end">
        <div class="btn-group" role="group" aria-label="Basic outlined example">
          <a class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modal-estudiante">Registrar</a>
          <a class="btn btn-outline-success" href="./colaboradores.php">Colaboradores</a>
          <a class="btn btn-outline-success" href="../main.php">Inicio</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <form action="" autocomplete="off" id="formulario-estudiantes" enctype="multipart/form-data">
          ...
          <div class="row">
              ...
              <div class="mb-3 col-md-6">
                ...
                <input type="text" maxlength="8" id="nrodocumento" class="form-control form-control-sm" autofocus>
              </div>
          </div>
