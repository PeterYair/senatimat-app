    ...
    <div class="card">
      ...
      <div class="card-body ">
        <div class="container mt-3">
          <table class="table table-striped text-center" id="tabla-colaboradores">
          <colgroup>
            <col width="5%">
            <col width="15%">
            <col width="10%">
        ...
        <div class="card-footer text-end">
          <div class="btn-group" role="group" aria-label="Basic outlined example">
            <a class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalRegistro">Registrar</a>
            <a class="btn btn-outline-success" href="./estudiantes.php">Estudiantes</a>
        ...
        <form action="" autocomplete="off" id="formulario-colaboradores" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="text" maxlength="9" id="telefono" class="form-control form-control-sm" autofocus>
            </div>
          </div>
